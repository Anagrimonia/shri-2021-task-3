### Тестовое задание 3. Поиск ошибок

**Что было сделано:**
- найдены и исправлены ошибки, влияющие на работоспособность приложения;
- добавлены слайды, разработанные для задания #1;
- проверена работа интерактивных элементов на слайдах.

**Найденные ошибки:** \
Коммиты с ошибками можно посмотреть в пулл-реквесте [Debugging](https://github.com/Anagrimonia/shri-2021-task-3/pull/1). \
Внутри каждого коммита содержатся комментарии к измененным строкам кода.
